...
//    }
    ...
    if ((avFSR1 <0.01) && (avFSR2 < 0.01) && (n == 0)) {
    ...
    if ((avFSR1 < 0.01) && (avFSR2 < 0.01) && (n == 1)) {
      lcd.print("Thank!");
      m1 = 0;
      m2 = 0;
      Servo1.write(30);
    ...
    if ((avFSR1 > 0.01) && (avFSR2 > 0.01) && (m1 == 1)) {
      n = 1;
      lcd.setCursor(0, 0);               //设置显示指针
      lcd.print("LCD1602 iic Test");     //输出字符到LCD1602上
      lcd.setCursor(0, 1);
    ...
    if ((avFSR1 > 0.01) && (avFSR2 > 0.01) && (m2 == 1)) {
      n = 1;
      lcd.setCursor(0, 0);               //设置显示指针
      lcd.print("LCD1602 iic Test");     //输出字符到LCD1602上
      lcd.setCursor(0, 1);
    ...
    if ((avFSR1 > 0.01) && (avFSR2 > 0.01) && (m1 == 0) && (m2 == 0)) {
      n = 1;
      lcd.setCursor(0, 0);               //设置显示指针
      lcd.print("LCD1602 iic Test");     //输出字符到LCD1602上
      lcd.setCursor(0, 1);
